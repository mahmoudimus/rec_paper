...
try:
	...
	_s.add(t2_var1 == t2_var4(_N1))
	_s.add(t1_var1 == t1_var4(_N1))
	_s.add(ForAll([_n1],Implies(_n1>=0,y4(_n1 + 1) == x4(_n1) + y4(_n1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,x4(_n1 + 1) == x4(_n1) + y4(_n1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,t2_var4(_n1 + 1) == y4(_n1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,t1_var4(_n1 + 1) == x4(_n1))))
	_s.add(t2_var4(0) == t2_var)
	_s.add(t1_var4(0) == t1_var)
	...
	_s.add(_N1>=0)
        _s.add(Not((If(_N1==0,1,If(_N1==1,2,_power(2,(_N1+1))))) >= 1))
