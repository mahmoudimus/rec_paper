...
try:
	...
	_s.add(i1 == _N1)
	_s.add(k1 == __VERIFIER_nondet_int4)
	_s.add(j1 == ((_N1 + _N1*_N1)/(2)))
	_s.add(n1 == __VERIFIER_nondet_int2)
	_s.add(flag1 == __VERIFIER_nondet_int3)
	_s.add(z1 == ((((__VERIFIER_nondet_int4)+(_N1)))+(((_N1 + _N1*_N1)/(2)))))
	...
	_s.add(_N1>=0)
	_s.add(Implies(((__VERIFIER_nondet_int3)>(0)),((__VERIFIER_nondet_int4)>=(0))))
	_s.add(((__VERIFIER_nondet_int2)<(LARGE_INT)))
	_s.add(((__VERIFIER_nondet_int2)>=(0)))
	_s.add(Not(((((((If(((__VERIFIER_nondet_int3)>(0)),__VERIFIER_nondet_int4,1))+(_N1)))+(((_N1 + _N1*_N1)/(2)))))>(((2)*(__VERIFIER_nondet_int2))))))
