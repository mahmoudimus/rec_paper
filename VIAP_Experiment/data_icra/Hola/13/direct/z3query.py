...
try:
	...
	_s.add(j1 == If(((__VERIFIER_nondet_int2)>(0)),2 + 4*_N1,2 + 2*_N1))
	_s.add(k1 == If(((__VERIFIER_nondet_int2)>(0)),0,_N1))
	...
	_s.add(_N1>=0)
	_s.add(Not(Implies((If(((__VERIFIER_nondet_int2)>(0)),0,_N1)!=(0)),((If(((__VERIFIER_nondet_int2)>(0)),2 + 4*_N1,2 + 2*_N1))==(2*If(((__VERIFIER_nondet_int2)>(0)),0,_N1) + 2)))))
