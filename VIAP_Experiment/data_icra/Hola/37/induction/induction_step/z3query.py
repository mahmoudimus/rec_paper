...
try:
	...
	m1=Int('m1')
	m3=Function('m3',IntSort(),IntSort())
	n1=Int('n1')
	x1=Int('x1')
        _k1=Int('_k1')
	main=Int('main')
	...
	_s.add(ForAll([_n1],Implies(_n1>=0,m3(_n1 + 1) == If(((__VERIFIER_nondet_int3(_n1))>(0)),_n1,m3(_n1)))))
	_s.add(m3(0) == 0)
	...
	_s.add(_N1>=0)
        _s.add(_k1>=0)
	_s.add(Not(Implies(Implies(((__VERIFIER_nondet_int2)>(0)),And(0 <= m3(_k1),((m3(_k1))<(__VERIFIER_nondet_int2)))),Implies(((__VERIFIER_nondet_int2)>(0)),And(0 <= m3(_k1+1),((m3(_k1+1))<(__VERIFIER_nondet_int2)))))))
